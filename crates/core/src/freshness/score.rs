...
mod tests {
    ...
    fn test_sensitivity_modes() {
        ...
        let score_relaxed = calculate_freshness(135.0, RetentionTier::Mid, SensitivityMode::Relaxed);
    ...
    fn test_default_tier() {
        assert_eq!(default_tier_for_source("com.doxus.github"), RetentionTier::Short);
        assert_eq!(default_tier_for_source("com.doxus.confluence"), RetentionTier::Mid);
        assert_eq!(default_tier_for_source("com.doxus.obsidian"), RetentionTier::Mid);
    }
}
